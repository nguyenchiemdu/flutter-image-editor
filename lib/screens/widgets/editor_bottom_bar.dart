...
class _EditorBottomBarState extends State<EditorBottomBar> {
  ...
  late final imageState = widget.imageState;
                ...
                ColorSelectorBottomSheet(
                  ...
                  onColorSelected: (Color color) {
                    ...
                    final signatureController =
                        SignatureController(penStrokeWidth: 4, penColor: color);
          ...
          AnimatedContainer(
            ...
            child: Row(
              children: [
                ColorSelectorBottomSheet(
                  list: textColors,
                  selectedColor: imageState.mStackedWidgetList.last.textColor,
            ...
            child: Wrap(
              ...
              children: [
                Container(
                  ...
                  decoration: imageState.mStackedWidgetList.last.fontStyle ==
                          FontStyle.normal
                      ? BoxDecoration(
            ...
            children: [
              ListView(
                ...
                children: [
                  ...
                  BottomBarItemWidget(
                      title: 'Stickers',
                      icons: const Icon(FontAwesomeIcons.faceSmileWink).icon,
                      onTap: () {
                        setState(() {
                          onStickerClick();
                        });
